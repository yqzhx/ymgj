 ...
 * 
 * 已修改源码，设置top：boolean  container:[string,element] 全屏显示
 */
...
(function (global, factory) {
  ...
  var events = {
    bind: function bind() {
      var options = this.options,
          viewer = this.viewer,
          canvas = this.canvas;
      var document = options.top?top.document:this.element.ownerDocument;
  ...
  var methods = {
    ...
    view: function view() {
      ...
      var image = options.top?top.document.createElement('img'):document.createElement('img');
      image.src = url;
      image.alt = alt;
  ...
  var others = {
    ...
    requestFullscreen: function requestFullscreen() {
      var document = this.options.top?top.document:this.element.ownerDocument;
