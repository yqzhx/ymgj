package com.uustop.project.system.menu.controller;
...
public class MenuController extends BaseController
{
    ...
    public AjaxResult remove(@PathVariable("menuId") Long menuId)
    {
        ...
        {
            return error(1, "菜单已分配角色模块,不允许删除");
        }
        Menu menu = menuService.selectMenuById(menuId);
        menu.setDelFlag("1");
        menu.setUpdateBy(this.getLoginName());
    ...
    @RequiresPermissions("system:menu:visible")
    @PostMapping("/visible/{menuId}")
    @ResponseBody
    public AjaxResult visible(@PathVariable("menuId") Long menuId)
    {
        return toAjax(menuService.visibleMenuById(menuId));
    }
