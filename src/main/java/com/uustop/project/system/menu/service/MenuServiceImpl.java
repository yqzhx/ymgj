package com.uustop.project.system.menu.service;
...
import com.uustop.common.utils.TreeUtils;
import com.uustop.common.utils.security.ShiroUtils;
import com.uustop.project.system.menu.domain.Menu;
import com.uustop.project.system.menu.mapper.MenuMapper;
import com.uustop.project.system.role.domain.Role;
import com.uustop.project.system.role.mapper.RoleMenuMapper;
...
//        List<Menu> menuList = menuMapper.selectMenuAll();
        List<Menu> menuList = menuMapper.selectAllDisplayMenus();
    ...
    public List<Menu> selectMenuByParent(Long menuId){
        List<Menu>  menulist =   menuMapper.selectMenuByParent(menuId);
        for (int i=0;i<menulist.size();i++){
            if(menulist.get(i)!=null){
                List<Menu>  templist = selectMenuByParent(menulist.get(i).getMenuId());
    ...
    @Override
    public int visibleMenuById(Long menuId)
    {
        List<Menu>  menulist =   this.selectMenuByParent(menuId);
        ShiroUtils.clearCachedAuthorizationInfo();
