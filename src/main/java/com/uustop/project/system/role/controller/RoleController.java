package com.uustop.project.system.role.controller;
...
public class RoleController extends BaseController
{
    ...
    @ResponseBody
    public AjaxResult status(@PathVariable("roleId") Long roleId)
    {
        try
        {
            return toAjax(roleService.statusRoleById(roleId));
        }catch (Exception e)
        {
            return error(e.getMessage());
        }
