 ...
 * @Date: 2019-05-24
 */
public interface MfrsPictureMapper {
    /**
     * 查询厂商图片中间信息
     *
     ...
     * @return 结果
     */
    public int deleteMfrsPictureById(Integer mfrsPictureId);

    /**
     * 批量删除厂商图片中间
     *
     * @param mfrsPictureIds 需要删除的数据ID
     * @return 结果
     */
    public int deleteMfrsPictureByIds(String[] mfrsPictureIds);
